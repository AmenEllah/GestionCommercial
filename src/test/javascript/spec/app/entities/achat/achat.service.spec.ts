    ...
    describe('Achat Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/achats';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Achat', () => {
                service.create(new Achat(null)).subscribe(received => {
            ...
            it('should update a Achat', () => {
                service.update(new Achat(123)).subscribe(received => {
