    ...
    describe('FactureAchat Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/facture-achats';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a FactureAchat', () => {
                service.create(new FactureAchat(null)).subscribe(received => {
            ...
            it('should update a FactureAchat', () => {
                service.update(new FactureAchat(123)).subscribe(received => {
            ...
            it('should return a FactureAchat', () => {
            ...
            it('should return a list of FactureAchat', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new FactureAchat(123)]);
            });
