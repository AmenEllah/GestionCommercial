    ...
    describe('Reglement Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/reglements';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Reglement', () => {
                service.create(new Reglement(null)).subscribe(received => {
            ...
            it('should update a Reglement', () => {
                service.update(new Reglement(123)).subscribe(received => {
