    ...
    describe('Famille Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/familles';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Famille', () => {
                service.create(new Famille(null)).subscribe(received => {
            ...
            it('should update a Famille', () => {
                service.update(new Famille(123)).subscribe(received => {
