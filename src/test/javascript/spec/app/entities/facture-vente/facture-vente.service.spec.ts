    ...
    describe('FactureVente Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/facture-ventes';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a FactureVente', () => {
                service.create(new FactureVente(null)).subscribe(received => {
            ...
            it('should update a FactureVente', () => {
                service.update(new FactureVente(123)).subscribe(received => {
            ...
            it('should return a FactureVente', () => {
            ...
            it('should return a list of FactureVente', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new FactureVente(123)]);
            });
