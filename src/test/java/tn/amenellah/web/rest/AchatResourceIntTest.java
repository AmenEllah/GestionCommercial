...
public class AchatResourceIntTest {
    ...
    private static final Integer DEFAULT_REMISE = 1;
    private static final Integer UPDATED_REMISE = 2;
    ...
    public void createAchat() throws Exception {
        ...
        assertThat(testAchat.getRemise()).isEqualTo(DEFAULT_REMISE);
    }
    ...
    public void getAllAchats() throws Exception {
        ...
        restAchatMockMvc.perform(get("/api/achats?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].remise").value(hasItem(DEFAULT_REMISE)));
    }
    ...
    public void getAchat() throws Exception {
        ...
        restAchatMockMvc.perform(get("/api/achats/{id}", achat.getId()))
            ...
            .andExpect(jsonPath("$.remise").value(DEFAULT_REMISE));
    }
    @Test
    @Transactional
    ...
    public void updateAchat() throws Exception {
        ...
        assertThat(testAchat.getRemise()).isEqualTo(UPDATED_REMISE);
    }
